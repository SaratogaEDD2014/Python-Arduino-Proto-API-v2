...
{  
  ...
  delay(1); //wait for the string to be sent
}

/******************************************************************************
 * This function returns a zero if something is detected by the sensor, and a 1 otherwise
 ...
 * also sends back the analog data read by the sensor
 ******************************************************************************/
